...
test/asm/tmp/tmp10.o:     file format elf64-x86-64
...
0000000000000da0 <func_lerp_119(eve::avx_abi_v0::wide<double, eve::fixed<4l> >, eve::avx_abi_v0::wide<double, eve::fixed<4l> >, double)>:
     ...
     da4:	c5 fb 12 d2          	vmovddup %xmm2,%xmm2
     da8:	c5 fd 28 d8          	vmovapd %ymm0,%ymm3
     dac:	c4 e3 6d 18 d2 01    	vinsertf128 $0x1,%xmm2,%ymm2,%ymm2
     db2:	c5 ed 57 05 00 00 00 	vxorpd 0x0(%rip),%ymm2,%ymm0        # dba <func_lerp_119(eve::avx_abi_v0::wide<double, eve::fixed<4l> >, eve::avx_abi_v0::wide<double, eve::fixed<4l> >, double)+0x1a>
     db9:	00 
     dba:	c5 f5 59 ca          	vmulpd %ymm2,%ymm1,%ymm1
     dbe:	c5 fd 59 c3          	vmulpd %ymm3,%ymm0,%ymm0
     dc2:	c5 fd 58 c3          	vaddpd %ymm3,%ymm0,%ymm0
     dc6:	c5 fd 58 c1          	vaddpd %ymm1,%ymm0,%ymm0
     dca:	c3                   	ret    
